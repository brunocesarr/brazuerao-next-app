export class UserUrlPhotos {
  ...
  static readonly AMANDA_PHOTO_URL: string = `/users-photos/amanda.jpg`
  static readonly EDUARDA_PHOTO_URL: string = `/users-photos/eduarda.jpg`
  static readonly ELLEN_PHOTO_URL: string = `/users-photos/ellen.jpg`
  static readonly KAMILLA_PHOTO_URL: string = `/users-photos/kamilla.jpg`
}
